...
# Uses official VA API for searching for locations.  NOTE: underlying data source may not include some VA pop up vaccination events at smaller VA clinics or locations like VFW halls.
